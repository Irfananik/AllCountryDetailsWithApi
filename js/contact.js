const contactFormDataSubmited = () => {
    ...
    if (nameFieldValue && emailFieldValue && commentFieldValue === nameField.value, emailField.value, commentField.value) {
        alert("Your comment has been succesfully saved!")
    } else if (nameFieldValue && emailFieldValue && commentFieldValue !== nameField.value, emailField.value, commentField.value) {
